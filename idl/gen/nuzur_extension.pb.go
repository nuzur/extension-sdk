...
const (
	...
	ExecutionResponseType_EXECUTION_RESPONSE_TYPE_FAILURE ExecutionResponseType = 4
)
...
var (
	ExecutionResponseType_name = map[int32]string{
		...
		4: "EXECUTION_RESPONSE_TYPE_FAILURE",
	}
	ExecutionResponseType_value = map[string]int32{
		...
		"EXECUTION_RESPONSE_TYPE_FAILURE": 4,
	}
)
...
const (
	...
	EntityType_ENTITY_TYPE_LOCAL_AGENT            EntityType = 10
	EntityType_ENTITY_TYPE_LOCAL_AGENT_CONNECTION EntityType = 11
)
...
var (
	EntityType_name = map[int32]string{
		...
		10: "ENTITY_TYPE_LOCAL_AGENT",
		11: "ENTITY_TYPE_LOCAL_AGENT_CONNECTION",
	}
	EntityType_value = map[string]int32{
		...
		"ENTITY_TYPE_LOCAL_AGENT":            10,
		"ENTITY_TYPE_LOCAL_AGENT_CONNECTION": 11,
	}
)
...
type ExecutionResponseTypeData struct {
	...
	Failure       *ExecutionResponseTypeFailureData `protobuf:"bytes,4,opt,name=failure,proto3" json:"failure,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecutionResponseTypeData) GetFailure() *ExecutionResponseTypeFailureData {
	if x != nil {
		return x.Failure
	}
	return nil
...
type ExecutionResponseTypeFailureData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ExecutionResponseTypeFailureData) Reset() {
	*x = ExecutionResponseTypeFailureData{}
	mi := &file_nuzur_extension_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExecutionResponseTypeFailureData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecutionResponseTypeFailureData) ProtoMessage() {}

func (x *ExecutionResponseTypeFailureData) ProtoReflect() protoreflect.Message {
	mi := &file_nuzur_extension_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecutionResponseTypeFailureData.ProtoReflect.Descriptor instead.
func (*ExecutionResponseTypeFailureData) Descriptor() ([]byte, []int) {
	return file_nuzur_extension_proto_rawDescGZIP(), []int{8}
}

func (x *ExecutionResponseTypeFailureData) GetErrorMessage() string {
	if x != nil {
...
func (x *ExtensionInputEnumOption) Reset() {
	*x = ExtensionInputEnumOption{}
	mi := &file_nuzur_extension_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExtensionInputEnumOption) Descriptor() ([]byte, []int) {
	return file_nuzur_extension_proto_rawDescGZIP(), []int{21}
}
...
const file_nuzur_extension_proto_rawDesc = "" +
	"\n" +
	"\x15nuzur_extension.proto\",\n" +
	"\x12GetMetadataRequest\x12\x16\n" +
	"\x06locale\x18\x01 \x01(\tR\x06locale\"\xd7\x01\n" +
	"\x13GetMetadataResponse\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12!\n" +
	"\fversion_uuid\x18\x02 \x01(\tR\vversionUuid\x12\x1e\n" +
	"\n" +
	"identifier\x18\x03 \x01(\tR\n" +
	"identifier\x12!\n" +
	"\fdisplay_name\x18\x04 \x01(\tR\vdisplayName\x12 \n" +
	"\vdescription\x18\x05 \x01(\tR\vdescription\x12$\n" +
	"\rnumberOfSteps\x18\x06 \x01(\x05R\rnumberOfSteps\"\xdf\x01\n" +
	"\x15StartExecutionRequest\x12!\n" +
	"\fproject_uuid\x18\x01 \x01(\tR\vprojectUuid\x120\n" +
	"\x14project_version_uuid\x18\x02 \x01(\tR\x12projectVersionUuid\x124\n" +
	"\x16project_extension_uuid\x18\x03 \x01(\tR\x14projectExtensionUuid\x12#\n" +
	"\rconfig_values\x18\x04 \x01(\tR\fconfigValues\x12\x16\n" +
	"\x06locale\x18\x05 \x01(\tR\x06locale\"\x9b\x01\n" +
	"\x16StartExecutionResponse\x12%\n" +
	"\x0eexecution_uuid\x18\x01 \x01(\tR\rexecutionUuid\x12*\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.ExecutionResponseTypeR\x04type\x12.\n" +
	"\x04data\x18\x03 \x01(\v2\x1a.ExecutionResponseTypeDataR\x04data\"\xfa\x01\n" +
	"\x19ExecutionResponseTypeData\x125\n" +
	"\x05final\x18\x01 \x01(\v2\x1f.ExecutionResponseTypeFinalDataR\x05final\x122\n" +
	"\x04step\x18\x02 \x01(\v2\x1e.ExecutionResponseTypeStepDataR\x04step\x125\n" +
	"\x05async\x18\x03 \x01(\v2\x1f.ExecutionResponseTypeAsyncDataR\x05async\x12;\n" +
	"\afailure\x18\x04 \x01(\v2!.ExecutionResponseTypeFailureDataR\afailure\"\xab\x02\n" +
	"\x1eExecutionResponseTypeFinalData\x12(\n" +
	"\x06status\x18\x01 \x01(\x0e2\x10.ExecutionStatusR\x06status\x12%\n" +
	...
	"\rdisplay_block\x18\x03 \x01(\v2\x1e.ExecutionResponseDisplayBlockR\fdisplayBlock\x129\n" +
	"\rinputs_fields\x18\x04 \x03(\v2\x14.ExtensionInputFieldR\finputsFields\"G\n" +
	" ExecutionResponseTypeFailureData\x12#\n" +
	"\rerror_message\x18\x01 \x01(\tR\ferrorMessage\"\xce\x01\n" +
	"\x1dExecutionResponseDisplayBlock\x12\x1e\n" +
	"\n" +
	...
	"\fcontent_type\x18\x05 \x01(\x0e2\x18.DisplayBlockContentTypeR\vcontentType\"\xe3\x01\n" +
	"\x1aSubmitExectuionStepRequest\x12%\n" +
	"\x0eexecution_uuid\x18\x01 \x01(\tR\rexecutionUuid\x12'\n" +
	"\x0fstep_identifier\x18\x02 \x01(\tR\x0estepIdentifier\x12\x1c\n" +
	"\tconfirmed\x18\x03 \x01(\bR\tconfirmed\x12?\n" +
	"\finput_values\x18\x04 \x03(\v2\x1c.ExecutionStepDataInputValueR\vinputValues\x12\x16\n" +
	"\x06locale\x18\x05 \x01(\tR\x06locale\"S\n" +
	"\x1bExecutionStepDataInputValue\x12\x1e\n" +
	"\n" +
	"identifier\x18\x01 \x01(\tR\n" +
	"identifier\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\xa0\x01\n" +
	"\x1bSubmitExectuionStepResponse\x12%\n" +
	"\x0eexecution_uuid\x18\x01 \x01(\tR\rexecutionUuid\x12*\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.ExecutionResponseTypeR\x04type\x12.\n" +
	"\x04data\x18\x03 \x01(\v2\x1a.ExecutionResponseTypeDataR\x04data\"T\n" +
	"\x13GetExecutionRequest\x12%\n" +
	"\x0eexecution_uuid\x18\x01 \x01(\tR\rexecutionUuid\x12\x16\n" +
	"\x06locale\x18\x02 \x01(\tR\x06locale\"\xd0\x02\n" +
	"\x14GetExecutionResponse\x12(\n" +
	"\x06status\x18\x01 \x01(\x0e2\x10.ExecutionStatusR\x06status\x12\x1d\n" +
	"\n" +
	"status_msg\x18\x02 \x01(\tR\tstatusMsg\x12*\n" +
	"\x04type\x18\x03 \x01(\x0e2\x16.ExecutionResponseTypeR\x04type\x12.\n" +
	"\x04data\x18\x04 \x01(\v2\x1a.ExecutionResponseTypeDataR\x04data\x12!\n" +
	"\ftime_elapsed\x18\x05 \x01(\tR\vtimeElapsed\x128\n" +
	"\x18estimated_time_remaining\x18\x06 \x01(\tR\x16estimatedTimeRemaining\x126\n" +
	"\x17current_step_identifier\x18\a \x01(\tR\x15currentStepIdentifier\"f\n" +
	"\x1cExtensionConfigurationEntity\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12,\n" +
	"\x06fields\x18\x02 \x03(\v2\x14.ExtensionInputFieldR\x06fields\"\x8f\x02\n" +
	"\x13ExtensionInputField\x12\x12\n" +
	...
	"\x04type\x18\x06 \x01(\x0e2\x13.ExtensionInputTypeR\x04type\x12:\n" +
	"\vtype_config\x18\a \x01(\v2\x19.ExtensionInputTypeConfigR\n" +
	"typeConfig\"\xb6\x01\n" +
	"\x18ExtensionInputTypeConfig\x121\n" +
	"\x04uuid\x18\x01 \x01(\v2\x1d.ExtensionInputTypeUUIDConfigR\x04uuid\x121\n" +
	"\x04enum\x18\x02 \x01(\v2\x1d.ExtensionInputTypeEnumConfigR\x04enum\x124\n" +
	"\x05array\x18\x03 \x01(\v2\x1e.ExtensionInputTypeArrayConfigR\x05array\"L\n" +
	"\x1cExtensionInputTypeUUIDConfig\x12,\n" +
	"\ventity_type\x18\x01 \x01(\x0e2\v.EntityTypeR\n" +
	"entityType\"z\n" +
	"\x1cExtensionInputTypeEnumConfig\x12%\n" +
	"\x0eallow_multiple\x18\x01 \x01(\bR\rallowMultiple\x123\n" +
	"\aoptions\x18\x02 \x03(\v2\x19.ExtensionInputEnumOptionR\aoptions\"\x9a\x01\n" +
	"\x1dExtensionInputTypeArrayConfig\x122\n" +
	"\n" +
	"array_type\x18\x01 \x01(\x0e2\x13.ExtensionInputTypeR\tarrayType\x12E\n" +
	"\x11array_type_config\x18\x02 \x01(\v2\x19.ExtensionInputTypeConfigR\x0farrayTypeConfig\"P\n" +
	"\x18ExtensionInputEnumOption\x12\x1e\n" +
	"\n" +
	"identifier\x18\x01 \x01(\tR\n" +
	"identifier\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value*\xc9\x01\n" +
	"\x15ExecutionResponseType\x12#\n" +
	"\x1fEXECUTION_RESPONSE_TYPE_INVALID\x10\x00\x12!\n" +
	"\x1dEXECUTION_RESPONSE_TYPE_FINAL\x10\x01\x12 \n" +
	"\x1cEXECUTION_RESPONSE_TYPE_STEP\x10\x02\x12!\n" +
	"\x1dEXECUTION_RESPONSE_TYPE_ASYNC\x10\x03\x12#\n" +
	"\x1fEXECUTION_RESPONSE_TYPE_FAILURE\x10\x04*\xad\x01\n" +
	"\x0fExecutionStatus\x12\x1c\n" +
	"\x18EXECUTION_STATUS_INVALID\x10\x00\x12\x1f\n" +
	"\x1bEXECUTION_STATUS_INPROGRESS\x10\x01\x12\x1e\n" +
	"\x1aEXECUTION_STATUS_SUCCEEDED\x10\x02\x12\x1b\n" +
	"\x17EXECUTION_STATUS_FAILED\x10\x03\x12\x1e\n" +
	"\x1aEXECUTION_STATUS_CANCELLED\x10\x04*\xb5\x01\n" +
	"\x11ExecutionStepType\x12\x1f\n" +
	"\x1bEXECUTION_STEP_TYPE_INVALID\x10\x00\x12$\n" +
	" EXECUTION_STEP_TYPE_CONFIRMATION\x10\x01\x12#\n" +
	"\x1fEXECUTION_STEP_TYPE_DATAREQUEST\x10\x02\x124\n" +
	"0EXECUTION_STEP_TYPE_DATAREQUEST_AND_CONFIRMATION\x10\x03*\x82\x02\n" +
	"\x17DisplayBlockContentType\x12&\n" +
	"\"DISPLAY_BLOCK_CONTENT_TYPE_INVALID\x10\x00\x12)\n" +
	"%DISPLAY_BLOCK_CONTENT_TYPE_PLAIN_TEXT\x10\x01\x12#\n" +
	"\x1fDISPLAY_BLOCK_CONTENT_TYPE_JSON\x10\x02\x12\"\n" +
	"\x1eDISPLAY_BLOCK_CONTENT_TYPE_SQL\x10\x03\x12$\n" +
	" DISPLAY_BLOCK_CONTENT_TYPE_PROTO\x10\x04\x12%\n" +
	"!DISPLAY_BLOCK_CONTENT_TYPE_GOLANG\x10\x05*\xdb\x02\n" +
	"\x12ExtensionInputType\x12 \n" +
	"\x1cEXTENSION_INPUT_TYPE_INVALID\x10\x00\x12\x1d\n" +
	"\x19EXTENSION_INPUT_TYPE_UUID\x10\x01\x12 \n" +
	"\x1cEXTENSION_INPUT_TYPE_INTEGER\x10\x02\x12\x1e\n" +
	"\x1aEXTENSION_INPUT_TYPE_FLOAT\x10\x03\x12 \n" +
	"\x1cEXTENSION_INPUT_TYPE_BOOLEAN\x10\x04\x12\x1f\n" +
	"\x1bEXTENSION_INPUT_TYPE_STRING\x10\x05\x12\x1d\n" +
	"\x19EXTENSION_INPUT_TYPE_DATE\x10\x06\x12!\n" +
	"\x1dEXTENSION_INPUT_TYPE_DATETIME\x10\a\x12\x1d\n" +
	"\x19EXTENSION_INPUT_TYPE_ENUM\x10\b\x12\x1e\n" +
	"\x1aEXTENSION_INPUT_TYPE_ARRAY\x10\t*\xe6\x02\n" +
	"\n" +
	"EntityType\x12\x17\n" +
	"\x13ENTITY_TYPE_INVALID\x10\x00\x12\x1a\n" +
	"\x16ENTITY_TYPE_ENTITY_ALL\x10\x01\x12!\n" +
	"\x1dENTITY_TYPE_ENTITY_STANDALONE\x10\x02\x12 \n" +
	"\x1cENTITY_TYPE_ENTITY_DEPENDANT\x10\x03\x12\x1c\n" +
	"\x18ENTITY_TYPE_RELATIONSHIP\x10\x04\x12\x15\n" +
	"\x11ENTITY_TYPE_FIELD\x10\x05\x12\x14\n" +
	"\x10ENTITY_TYPE_ENUM\x10\x06\x12\x15\n" +
	"\x11ENTITY_TYPE_INDEX\x10\a\x12\x18\n" +
	"\x14ENTITY_TYPE_DB_STORE\x10\b\x12\x1d\n" +
	"\x19ENTITY_TYPE_DB_CONNECTION\x10\t\x12\x1b\n" +
	"\x17ENTITY_TYPE_LOCAL_AGENT\x10\n" +
	"\x12&\n" +
	"\"ENTITY_TYPE_LOCAL_AGENT_CONNECTION\x10\v2\xa4\x02\n" +
	"\x0eNuzurExtension\x12:\n" +
	"\vGetMetadata\x12\x13.GetMetadataRequest\x1a\x14.GetMetadataResponse\"\x00\x12C\n" +
	"\x0eStartExecution\x12\x16.StartExecutionRequest\x1a\x17.StartExecutionResponse\"\x00\x12=\n" +
	"\fGetExecution\x12\x14.GetExecutionRequest\x1a\x15.GetExecutionResponse\"\x00\x12R\n" +
	"\x13SubmitExectuionStep\x12\x1b.SubmitExectuionStepRequest\x1a\x1c.SubmitExectuionStepResponse\"\x00B(\n" +
	"\x0enuzurextensionB\x0eNuzurExtensionP\x01Z\x04gen/b\x06proto3"
...
var file_nuzur_extension_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_nuzur_extension_proto_goTypes = []any{
	...
	(*ExecutionResponseTypeFailureData)(nil), // 14: ExecutionResponseTypeFailureData
	(*ExecutionResponseDisplayBlock)(nil),    // 15: ExecutionResponseDisplayBlock
	(*SubmitExectuionStepRequest)(nil),       // 16: SubmitExectuionStepRequest
	(*ExecutionStepDataInputValue)(nil),      // 17: ExecutionStepDataInputValue
	(*SubmitExectuionStepResponse)(nil),      // 18: SubmitExectuionStepResponse
	(*GetExecutionRequest)(nil),              // 19: GetExecutionRequest
	(*GetExecutionResponse)(nil),             // 20: GetExecutionResponse
	(*ExtensionConfigurationEntity)(nil),     // 21: ExtensionConfigurationEntity
	(*ExtensionInputField)(nil),              // 22: ExtensionInputField
	(*ExtensionInputTypeConfig)(nil),         // 23: ExtensionInputTypeConfig
	(*ExtensionInputTypeUUIDConfig)(nil),     // 24: ExtensionInputTypeUUIDConfig
	(*ExtensionInputTypeEnumConfig)(nil),     // 25: ExtensionInputTypeEnumConfig
	(*ExtensionInputTypeArrayConfig)(nil),    // 26: ExtensionInputTypeArrayConfig
	(*ExtensionInputEnumOption)(nil),         // 27: ExtensionInputEnumOption
}
var file_nuzur_extension_proto_depIdxs = []int32{
	...
	14, // 5: ExecutionResponseTypeData.failure:type_name -> ExecutionResponseTypeFailureData
	1,  // 6: ExecutionResponseTypeFinalData.status:type_name -> ExecutionStatus
	15, // 7: ExecutionResponseTypeFinalData.display_blocks:type_name -> ExecutionResponseDisplayBlock
	2,  // 8: ExecutionResponseTypeStepData.type:type_name -> ExecutionStepType
	15, // 9: ExecutionResponseTypeStepData.display_block:type_name -> ExecutionResponseDisplayBlock
	22, // 10: ExecutionResponseTypeStepData.inputs_fields:type_name -> ExtensionInputField
	3,  // 11: ExecutionResponseDisplayBlock.content_type:type_name -> DisplayBlockContentType
	17, // 12: SubmitExectuionStepRequest.input_values:type_name -> ExecutionStepDataInputValue
	0,  // 13: SubmitExectuionStepResponse.type:type_name -> ExecutionResponseType
	10, // 14: SubmitExectuionStepResponse.data:type_name -> ExecutionResponseTypeData
	1,  // 15: GetExecutionResponse.status:type_name -> ExecutionStatus
	0,  // 16: GetExecutionResponse.type:type_name -> ExecutionResponseType
	10, // 17: GetExecutionResponse.data:type_name -> ExecutionResponseTypeData
	22, // 18: ExtensionConfigurationEntity.fields:type_name -> ExtensionInputField
	4,  // 19: ExtensionInputField.type:type_name -> ExtensionInputType
	23, // 20: ExtensionInputField.type_config:type_name -> ExtensionInputTypeConfig
	24, // 21: ExtensionInputTypeConfig.uuid:type_name -> ExtensionInputTypeUUIDConfig
	25, // 22: ExtensionInputTypeConfig.enum:type_name -> ExtensionInputTypeEnumConfig
	26, // 23: ExtensionInputTypeConfig.array:type_name -> ExtensionInputTypeArrayConfig
	5,  // 24: ExtensionInputTypeUUIDConfig.entity_type:type_name -> EntityType
	27, // 25: ExtensionInputTypeEnumConfig.options:type_name -> ExtensionInputEnumOption
	4,  // 26: ExtensionInputTypeArrayConfig.array_type:type_name -> ExtensionInputType
	23, // 27: ExtensionInputTypeArrayConfig.array_type_config:type_name -> ExtensionInputTypeConfig
	6,  // 28: NuzurExtension.GetMetadata:input_type -> GetMetadataRequest
	8,  // 29: NuzurExtension.StartExecution:input_type -> StartExecutionRequest
	19, // 30: NuzurExtension.GetExecution:input_type -> GetExecutionRequest
	16, // 31: NuzurExtension.SubmitExectuionStep:input_type -> SubmitExectuionStepRequest
	7,  // 32: NuzurExtension.GetMetadata:output_type -> GetMetadataResponse
	9,  // 33: NuzurExtension.StartExecution:output_type -> StartExecutionResponse
	20, // 34: NuzurExtension.GetExecution:output_type -> GetExecutionResponse
	18, // 35: NuzurExtension.SubmitExectuionStep:output_type -> SubmitExectuionStepResponse
