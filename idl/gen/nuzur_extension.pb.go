...
const file_nuzur_extension_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\v2\x1a.ExecutionResponseTypeDataR\x04data\"\xbd\x01\n" +
	...
	"\x05async\x18\x03 \x01(\v2\x1f.ExecutionResponseTypeAsyncDataR\x05async\"\xab\x02\n" +
	...
	"\rinputs_fields\x18\x04 \x03(\v2\x14.ExtensionInputFieldR\finputsFields\"\xce\x01\n" +
	...
	"\x1dEXECUTION_RESPONSE_TYPE_ASYNC\x10\x03*\xad\x01\n" +
