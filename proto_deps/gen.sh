...
sed -i '' 's/nem\/idl\/gen/github.com\/nuzur\/extension-sdk\/proto_deps\/nem\/idl\/gen/g' ./gen/product.pb.go
sed -i '' 's/nem\/idl\/gen/github.com\/nuzur\/extension-sdk\/proto_deps\/nem\/idl\/gen/g' ./gen/product_grpc.pb.go