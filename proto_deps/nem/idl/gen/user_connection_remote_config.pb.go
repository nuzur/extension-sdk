...
var file_user_connection_remote_config_proto_rawDesc = []byte{
...
var (
	...
	file_user_connection_remote_config_proto_rawDescData = file_user_connection_remote_config_proto_rawDesc
)
...
func file_user_connection_remote_config_proto_rawDescGZIP() []byte {
	file_user_connection_remote_config_proto_rawDescOnce.Do(func() {
		file_user_connection_remote_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_user_connection_remote_config_proto_rawDescData)
	})
...
func file_user_connection_remote_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_user_connection_remote_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_user_connection_remote_config_proto_rawDesc = nil
